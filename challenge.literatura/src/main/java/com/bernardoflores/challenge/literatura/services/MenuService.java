package com.bernardoflores.challenge.literatura.services;


import com.bernardoflores.challenge.literatura.api.PeticionAPI;
import com.bernardoflores.challenge.literatura.modelos.Autor;
import com.bernardoflores.challenge.literatura.modelos.Idioma;
import com.bernardoflores.challenge.literatura.modelos.Libro;
import com.bernardoflores.challenge.literatura.modelos.LibroR;
import com.bernardoflores.challenge.literatura.json.JsonParser;
...
public class MenuService {
    ...
    public void guardarLibro() {
        List<LibroR> librosObtenidos = obtenerLibrosApi();
        ...
        LibroR LibroR = librosObtenidos.get(opcion - 1);
        Optional<Libro> libroTraidoDelRepo = libroService.obtenerLibroPorNombre(LibroR.titulo());
        Optional<Autor> autorTraidodelRepo = autorService.obtenerAutorPorNombre(LibroR.autores().get(0).nombre());
